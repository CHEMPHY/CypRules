...
int main(void)
{
    ...
    std::ifstream  data("2c9.p2m2fp3.cc.predict");
	std::ifstream  model("2c9.p2m2fp3.cc.rules");
	std::ofstream  output("2c9.p2m2fp3.cc.statistics");
	std::ifstream  descriptorfile("2c9.p2m2fp3.cc.cases");
