...
int main(int argc,char* argv[])
{
	...
	if(argc==2){
		...
		strcpy(str,argv[1]);
		strcat(str,"2c9.p2m2fp3.cc.predict");
		data.open(str);

		strcpy(str,argv[1]);
		strcat(str,"2c9.p2m2fp3.cc.rules");
		model.open(str);

		strcpy(str,argv[1]);
		strcat(str,"2c9.p2m2fp3.cc.statistics");
		output.open(str);

		strcpy(str,argv[1]);
		strcat(str,"2c9.p2m2fp3.cc.cases");
		descriptorfile.open(str);
	}
	else{
		data.open("2c9.p2m2fp3.cc.predict");
		model.open("2c9.p2m2fp3.cc.rules");
		output.open("2c9.p2m2fp3.cc.statistics");
		descriptorfile.open("2c9.p2m2fp3.cc.cases");
	}
	...
	//-----read each model
	for( i = 0 ; i < 10; i++ ){// for each model, 癘眔эmodel计ヘ
