java -jar ../bin/PaDEL-Descriptor/PaDEL-Descriptor.jar -2d -retain3d -standardizenitro -removesalt -detectaromaticity -retainorder -dir ../workspace/input/ -file ../workspace/3a4.p2fp3.cc2.case2 > ../workspace/log_PaDEL-Descriptor.txt
../bin/Mold2.exe -i input.sdf -o 3a4.m2.cc2.case2
