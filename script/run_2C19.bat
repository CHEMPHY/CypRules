java -jar ../bin/PaDEL-Descriptor/PaDEL-Descriptor.jar -2d -retain3d -standardizenitro -removesalt -detectaromaticity -retainorder -dir ../workspace/input/ -file ../workspace/2c19.p2fp3.cc.cases2 > ../workspace/log_PaDEL-Descriptor.txt
..\bin\Mold2.exe -i ..\workspace\input\input.sdf -o ..\workspace\2c19.m2.cc.cases2 < nul
